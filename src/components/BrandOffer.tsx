        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {offers.map((offer, i) => (
            <motion.div
              ...
              className="glass rounded-2xl p-8 hover:border-riot-red/30 transition-all duration-500 group cursor-hover relative overflow-hidden"
            >
              {/* Hover glow */}
              ...
              <h3 className="font-syne font-extrabold tracking-tight uppercase group-hover:text-gradient transition-all duration-300">
                {offer.title}
              </h3>
