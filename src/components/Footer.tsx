    ...
    <footer className="relative border-t border-white/5">
      <div className="max-w-[1400px] mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12 items-center">
          ...
          >
            <span className="font-syne font-extrabold uppercase tracking-widest text-white/90">
          ...
          >
            <p className="font-syne font-extrabold tracking-tighter leading-[0.8]2em] text-riot-light-gray">
